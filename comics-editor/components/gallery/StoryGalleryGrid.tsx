...
export function StoryGalleryGrid({ storySlug }: StoryGalleryGridProps) {
  const { data: strips, isLoading } = useQuery(queries.storyStrips(storySlug));
  ...
  if (isLoading) {
    return <StoryGalleryGridSkeleton />;
  }
    ...
    return (
      <div className="p-12 rounded-lg border border-dashed border-border bg-card/50 text-center">
        ...
        <Button variant="outline" asChild>
          <Link href={`/stories/${storySlug}/generate`}>Go to Generate</Link>
        </Button>
      </div>
    );
  }
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <Button variant="ghost" size="sm" asChild>
                  <Link
                    href={`/stories/${storySlug}/scenarios/${encodeURIComponent(scenarioName)}`}
                  >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Link
                  href={`/stories/${storySlug}/scenarios/${encodeURIComponent(selectedStrip.scenarioName)}`}
                >
                  <Pencil className="h-4 w-4 mr-1" />
                  Edit
                </Link>
              ...
              >
                <Link
                  href={`/stories/${storySlug}/generate?scenario=${encodeURIComponent(selectedStrip.scenarioName)}`}
                >
...
function StoryGalleryGridSkeleton() {
  return (
    <div className="space-y-8">
